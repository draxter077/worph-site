export default function update(){
    ...
    update.onclick = async function a(Event){
        await axios.post(apiAddress + '/postFile', formData, {headers: {'Content-Type': 'multipart/form-data', locID: document.getElementById("content").children[0].id, fileID: Event.target.parentElement.id}})
